...
image('buildMyModal', 'buildSmallImage', 'buildLargeImage', 'buildCloseModal');
image('myGiftMyModal', 'myGiftSmallImage', 'myGiftLargeImage', 'myGiftCloseModal');
image('productMyModal', 'productSmallImage', 'productLargeImage', 'productCloseModal');